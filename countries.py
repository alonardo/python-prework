# -*- coding: utf-8 -*-
"""
Created on Sun May 22 07:52:29 2022
...
for country in countries:
    if country['continent'] == 'africa'.title():
        print(country['name'])

for country in countries:
    if country['continent'] =='europe'.title():
        print('The capital of ' + country['name'] + ' is ' + country['capital'])
